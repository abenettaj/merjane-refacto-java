...
public class OrderControllerIntegrationTests {
    ...
    @Test
    public void processNonExistentOrderShouldReturnNotFoundStatus() throws Exception {
        mockMvc.perform(post("/orders/{orderId}/processOrder", "123")
                        .contentType("application/json"))
    ...
    private static List<Product> createProducts() {
        ...
        products.add(new Product(null, 15, 0, ProductType.SEASONAL, "Orange", null, LocalDate.now().minusDays(10),
                LocalDate.now().plusDays(10)));
        products.add(new Product(null, 15, 0, ProductType.SEASONAL, "Kiwi", null, LocalDate.now().minusDays(10),
